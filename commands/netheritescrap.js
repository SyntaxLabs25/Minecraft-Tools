...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('netheritescrap')
    .setDescription('Add Netherite Scrap')
  ...
  async execute(interaction) {
    ...
    ores['Netherite Scrap'] += amount;
    fs.writeFileSync(ORES_FILE, JSON.stringify(ores, null, 2));
    updateMiningStats(amount);
    await interaction.reply({ content: `✅ +**${amount} ${displayName}** (Total: **${ores['Netherite Scrap'].toLocaleString()}**)`, ephemeral: true });
