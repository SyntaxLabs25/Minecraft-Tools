...
module.exports = {
  ...
  async execute(interaction) {
    ...
    ores['Netherite'] += amount;
    fs.writeFileSync(ORES_FILE, JSON.stringify(ores, null, 2));
    updateMiningStats(amount);
    await interaction.reply({ content: `✅ +**${amount} ${displayName}** (Total: **${ores['Netherite'].toLocaleString()}**)`, ephemeral: true });
